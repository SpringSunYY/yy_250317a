  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        <el-table-column label="平台" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="platform" />
        <el-table-column label="店铺" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="storeId" />
        <el-table-column label="站点" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="marketplaceId" />
        <el-table-column label="订单号" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="amazonOrderId" />
        <el-table-column label="订购时间" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="purchaseDate" />
        <el-table-column label="ASIN" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="asin" />
        <el-table-column label="品名" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="title" />
        <el-table-column label="亚马逊评价链接" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible" prop="comment" />
        ...
        <el-table-column label="亚马逊评分星级" :show-overflow-tooltip="true" align="center" v-if="columns[10].visible" prop="evaluateLevel" />
        <el-table-column label="亚马逊评价内容" :show-overflow-tooltip="true" align="center" v-if="columns[11].visible" prop="evaluateContent" />
        <el-table-column label="亚马逊商品链接" :show-overflow-tooltip="true" align="center" v-if="columns[12].visible" prop="goodsLink" />
        ...
        <el-table-column label="买家姓名" :show-overflow-tooltip="true" align="center" v-if="columns[14].visible" prop="buyerName" />
        <el-table-column label="买家邮箱" :show-overflow-tooltip="true" align="center" v-if="columns[15].visible" prop="buyerEmail" />
        <el-table-column label="买家评分" :show-overflow-tooltip="true" align="center" v-if="columns[16].visible" prop="buyerLevel" />
        <el-table-column label="买家评论" :show-overflow-tooltip="true" align="center" v-if="columns[17].visible" prop="buyerEvaluate" />
        ...
        <el-table-column label="请求评论内容" :show-overflow-tooltip="true" align="center" v-if="columns[19].visible" prop="begEvalueteContent" />
        <el-table-column label="评论负责人" :show-overflow-tooltip="true" align="center" v-if="columns[20].visible" prop="evaluatePrincipal" />
        ...
        <el-table-column label="创建人" :show-overflow-tooltip="true" align="center" v-if="columns[22].visible" prop="userId" />
        <el-table-column label="创建时间" align="center" v-if="columns[23].visible" prop="createTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
        <el-table-column label="更新人" :show-overflow-tooltip="true" align="center" v-if="columns[24].visible" prop="updateBy" />
        <el-table-column label="更新时间" align="center" v-if="columns[25].visible" prop="updateTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.updateTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
        <el-table-column label="备注" :show-overflow-tooltip="true" align="center" v-if="columns[26].visible" prop="remark" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="站点" prop="marketplaceId">
          <el-input v-model="form.marketplaceId" placeholder="请输入站点" />
        </el-form-item>
        <el-form-item label="订单号" prop="amazonOrderId">
          <el-input v-model="form.amazonOrderId" placeholder="请输入订单号" />
        </el-form-item>
        <el-form-item label="订购时间" prop="purchaseDate">
          <el-input v-model="form.purchaseDate" placeholder="请输入订购时间" />
        </el-form-item>
        <el-form-item label="ASIN" prop="asin">
          <el-input v-model="form.asin" placeholder="请输入ASIN" />
        </el-form-item>
        <el-form-item label="品名" prop="title">
          <el-input v-model="form.title" placeholder="请输入品名" />
        </el-form-item>
        ...
        <el-form-item label="请求评论内容">
          <editor v-model="form.begEvalueteContent" :min-height="192"/>
        </el-form-item>
        <el-form-item label="评论负责人" prop="evaluatePrincipal">
